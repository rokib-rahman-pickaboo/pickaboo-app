...
abstract class $ResetPasswordRequestCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? mobile, String? email, String otp, String password});
}
...
class _$ResetPasswordRequestImpl implements _ResetPasswordRequest {
  ...
  @override
  String toString() {
    return 'ResetPasswordRequest(mobile: $mobile, email: $email, otp: $otp, password: $password)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, mobile, email, otp, password);
