...
_$CategoryBannerResponseImpl _$$CategoryBannerResponseImplFromJson(
  ...
  category:
      json['category'] == null
          ? null
          : CategoryBannerCategory.fromJson(
            json['category'] as Map<String, dynamic>,
          ),
);

Map<String, dynamic> _$$CategoryBannerResponseImplToJson(
  _$CategoryBannerResponseImpl instance,
) => <String, dynamic>{
...
_$CategoryBannerCategoryImpl _$$CategoryBannerCategoryImplFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$$CategoryBannerCategoryImplToJson(
  _$CategoryBannerCategoryImpl instance,
) => <String, dynamic>{
  'id': instance.id,
  'name': instance.name,
  'slug': instance.slug,
