...
List<BrandBannerGroup> groupBannersForBrand(
...
class BrandBannerSection extends StatelessWidget {
  final int categoryId;

  const BrandBannerSection({super.key, required this.categoryId});
  ...
  Widget build(BuildContext context) {
    ...
    final groups = groupBannersForBrand(banners, categoryId);
    ...
    return Column(
      ...
      children: [
        for (final group in groups)
          Padding(
            key: ValueKey(
              'brand_banner_${group.identifier}_'
