...
/// ============================================================================
/// 📦 INTERLEAVED BRAND PRODUCT RESULTS
///
...
class _BrandProductResultsState extends State<BrandProductResults> {
  ...
  List<FilterAttributeEntity> _extractQuestionAttributes(
    ...
    return CategoryQuestionHelper.extractQuestions(
      ...
      categorySlug: widget.brandKey ?? fallbackKey,
  ...
  Widget _buildGridView(BrandProductsState state, BuildContext context) {
  ...
  void _maybeFetchNextPage(BuildContext context, BrandProductsState state) {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<BrandProductsBloc>().add(
        BrandProductsEvent.getProducts(
          brandKey: widget.brandKey ?? state.brandKey,
        ),
      );
    });
