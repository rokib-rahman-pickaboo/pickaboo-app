...
import 'package:pickaboo/presentation/ui/widgets/special_category_product_page/inline_filter.dart';
...
class SpecialCategoryProductResults extends StatefulWidget {
  ...
  @override
  State<SpecialCategoryProductResults> createState() => _SpecialCategoryProductResultsState();
}

class _SpecialCategoryProductResultsState extends State<SpecialCategoryProductResults> {
  ...
  void _maybeFetchNextPage(BuildContext context, SpecialCategoryProductsState state) {
    final paging = state.pagingState;
  ...
  Widget _buildErrorState(BuildContext context, SpecialCategoryProductsState state) {
    return AppErrorView(
